...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "SELECT * FROM pelajar WHERE emel = ?";
...
if (password_verify($password, $user['kata_laluan'])) {
    ...
    $_SESSION['user_id'] = $user['id_pelajar'];
    $_SESSION['name'] = $user['nama_pelajar'];
    $_SESSION['role'] = 'pelajar';
    $_SESSION['email'] = $user['emel'];
    $_SESSION['matric'] = $user['no_matrik']; // Tambah baris ini ✅
...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
  ...
  <meta charset="UTF-8">
  <title>Login Pelajar - FSKTM FYP</title>
 <style>
