...
$id = intval($_GET['id']);
$stmt = $conn->prepare("SELECT t.*, u.full_name as supervisor_name FROM titles t LEFT JOIN users u ON t.supervisor_id = u.id WHERE t.id = ?");
...
<body>
    ...
    <br>
    <a href="admin_manage_titles.php">← Kembali ke Senarai Tajuk</a>
</body>
</html>